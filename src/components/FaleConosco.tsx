export function FaleConosco() {
    return (
        <div>
            <button className="flex  justify-evenly items-center w-[192px] h-[55px] fixed z-40 right-0 bottom-0  shadow-[inset_-12px_-8px_40px_#000000ac]  bg-bg-fc-blue rounded-t-lg">
                ...
                <p className="text-white ">Fala conosco</p>
            </button>
        </div>
    )
}