...
export function HomeResultSlide() {
    return (
            <section className="flex flex-wrap py-[70px] md:justify-center">
            <div className="flex flex-wrap lg:w-[1200px] md:w-[928px] sm:w-[600px] w-[350px] justify-between items-center px-[16px] md:px-0">
                    ...
                    <div className="flex  justify-center mb-5">
                        <h2 className="md:text-[42px] sm:text-[37.5px] font-bold leading-tight text-center lg:w-[1200px] md:w-[928px] sm:w-[608px]">O resultado: seu negócio mais <span className="text-primary-blue">organizado, <br/> produtivo </span> 
