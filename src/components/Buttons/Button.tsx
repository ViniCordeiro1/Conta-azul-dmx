...
export function Button({ name } : Props) {
    return (
        <button className="flex w-[121px] h-[40px]  justify-center items-center gap-1 bg-primary-blue rounded  shadow-[inset_-12px_-8px_40px_#0000004b] hover:bg-blue-600">
